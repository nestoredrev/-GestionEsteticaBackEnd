...
else
{
        ...
        $uploadfile =  'fotoPerfil_'.$idCliente.'_'.$numRandom.'.jpg';
        $uploadfilename = $_FILES['file']['tmp_name'];  
}

//__DIR__ devuelve la ruta absoluto del fichero subirFoto.php
$location = __DIR__.'/imgClientes/';  
...
if(move_uploaded_file($uploadfilename, $location.$uploadfile))
{
            ...
            $urlFoto = $uri."/appBackEnd/Clientes/imgClientes/".$uploadfile."";
            $misqli->query("UPDATE clientes SET urlFoto = '".$urlFoto."' WHERE id_cliente='".$idCliente."' ");
            //echo 'Foto guardada...';
}
else
{
